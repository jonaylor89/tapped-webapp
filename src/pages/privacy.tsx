    ...
    return (
        <>
            <div className="pl-24 pr-24">
                ...
                <h2 className="text-3xl mt-10 mb-5">Your Information</h2>

                <p>
                    We work for artists producers, creators, and musicians. And in order to provide you with our Services, we need to collect information from you to best serve your needs. Therefore, we may collect various types of information through the Services we provide. You can rest assured, we strictly use your “Personal Information” (i.e. information that personally identifies you or could be used to personally identify you) to provide the Services. We may also process Personal Information upon your consent.
                </p>

                <h2 className="text-3xl mt-10 mb-5">What you share with us</h2>
                ...
                <ul>
                    ...
                    <li>
                        Your payment information when you buy a paid subscription;
                    </li>
                    <li>
                    ...
                    <li>
                        Your list of contacts, if you grant us access;
                    </li>
                    <li>
                ...
                <h2 className="text-3xl mt-10 mb-5">What is shared with us through our Services</h2>
                ...
                We take matters regarding your information very seriously. We make sure that we use your Personal Information only when we absolutely need it to fulfill our duties to you and only give access to those employees who need to have access to it to fulfill their duties to you.
                ...
                To improve the performance of our recommendation algorithm and music engine based on the music you upload. You, the musician, retains ownership, copyright, and publishing rights of your music;
                ...
                <h2 className="text-3xl mt-10 mb-5">
                    How we may share Your Information</h2>
                ...
                <h2 className="text-3xl mt-10 mb-5">Your Preferences</h2>

                To give you the ability to control how you share your information with us, we offer you various options. Here are a few:

                You may be able to access or register for the Services through third parties (each, an “Integrated Service”), such as through your Google account, or otherwise allow an Integrated Service to provide Personal Information or other information to us. By allowing us to connect with an Integrated Service, you authorize us to access and store your name, email address(es), and other information that the Integrated Service shares with us, and to use and disclose it according to this Privacy Policy. You should check your privacy settings on each Integrated Service to find out what information is shared with us, and make changes according to your preferences. Please review each Integrated Service’s terms of use and privacy policies carefully before using their services to connect to our Services;
                You can edit your contact information and language of communication at all times. This is the best way to ensure that your Personal Information is accurate and up to date;
                You can change your password at all times;
                You can subscribe and unsubscribe to our promotional offers;
                You can log out of your account securely by clicking on the “Log Out” button;
                You can delete your account and all the data associated with it at any time through the app or website


                <h2 className="text-3xl mt-10 mb-5">Other Websites and Social Media</h2>
                ...
                <h2 className="text-3xl mt-10 mb-5">Right to Access and Correct</h2>
