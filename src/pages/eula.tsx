    ...
    return (
        <>
            <div className="pl-4 pr-4 md:pl-24 md:pr-24 md:pb-24">
                ...
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                    2.1. You agree to use the Tapped App in a manner consistent with all applicable laws, regulations, and this Agreement.
                </div>
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                    2.2. You acknowledge and agree that you are solely responsible for your conduct while using the Tapped App.
                </div>
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                    2.3. You shall not post, transmit, or share any content that is objectionable, offensive, abusive, harmful, defamatory, obscene, or otherwise violates any law or infringes upon the rights of others.
                </div>
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                    2.4. You shall not engage in any abusive, harassing, or discriminatory behavior towards other users of the Tapped App.
                </div>
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                    2.5. You shall not use the Tapped App for any unlawful or fraudulent purposes.
                </div>
                ...
                <div className="text-center md:text-start md:text-xl font-thin text-gray-300">
                By using the Tapped App, you signify your acceptance of this Agreement. If you do not agree to the terms and conditions outlined in this Agreement, please refrain from using the Tapped App.
                </div>
