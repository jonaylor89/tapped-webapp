    ...
    return (
        <>
            <div className="pl-24 pr-24">
                <h1 className="text-6xl mb-10 mt-20 text-center">
                ...
                <br /> A: Signing up for Tapped is quick and easy! Simply visit our website and create your account to start connecting with professionals in the music industry.

                <br /> Q: Is Tapped only for established professionals, or can newcomers join too?
                <br /> A: Tapped welcomes professionals at all stages of their music careers. Whether you&apos;re a seasoned executive or a budding artist, our platform offers valuable resources and opportunities for everyone.

                <br /> Q: Is Tapped available as a mobile app?
                <br /> A: Yes! Tapped is available as a mobile app for both iOS and Android devices, ensuring that you can stay connected and engaged while on the go.
